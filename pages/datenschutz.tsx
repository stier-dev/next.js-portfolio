  ...
  return (
    <div id="start" className={style.mainContainer}>
      <div className={style.textContainer}>
        <h1 className={`${style.all} ${style.jumbo} ${style.datenschutzJumbo}`}>
          Datenschutzerklärung
        </h1>
        <h2 className={`${style.all} ${style.headline}`}>Einleitung</h2>
        <p>
        ...
        <h2 className={`${style.all} ${style.headline}`}>Inhaltsübersicht</h2>
        <ul>
          <li>
        ...
        <h2 className={`${style.all} ${style.headline}`} id="m3">
          Verantwortlicher
        </h2>
        <p>
          Georgiy Stasyuk
        ...
        Impressum: <p>www.stier.dev/impressum</p>
        <h2 className={`${style.all} ${style.headline}`} id="mOverview">
        ...
        <h2 className={`${style.all} ${style.headline}`} id="m27">
        ...
        <h2 className={`${style.all} ${style.headline}`} id="m12">
          Löschung von Daten
        </h2>
        <p>
        ...
        <h2 className={`${style.all} ${style.headline}`} id="m317">
        ...
        <ul>
          ...
          <li>
            ...
            Vertragspartner; Schüler/ Studenten/ Teilnehmer.
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            (einheitlich bezeichnet als &quot; Aus- und Fortzubildende &quot;),
            um ihnen gegenüber unsere Schulungsleistungen erbringen zu können.
            Die hierbei verarbeiteten Daten, die Art, der Umfang, der Zweck und
            ...
            unserer Tätigkeit können wir ferner besondere Kategorien von Daten,
            hier insbesondere Angaben zur Gesundheit der Aus- und
          ...
          <li>
            <strong>Künstlerische und literarische Leistungen: </strong>Wir
            verarbeiten die Daten unserer Auftraggeber, um ihnen die Auswahl,
            den Erwerb bzw. die Beauftragung der gewählten Leistungen oder Werke
            sowie verbundener Tätigkeiten als auch deren Bezahlung und
            Zustellung bzw. Ausführung oder Erbringung zu ermöglichen. Die
            ...
            umfassen die zur Auslieferung und Abrechnung benötigten Angaben
            sowie Kontaktinformationen, um etwaige Rücksprachen halten zu
            können; <strong>Rechtsgrundlagen:</strong>
            Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1
            lit. b) DSGVO).
          </li>
          <li>
        ...
        <h2 className={`${style.all} ${style.headline}`} id="m225">
          Bereitstellung des Onlineangebotes und Webhosting
        </h2>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            und technischen Geräten (Computer, Server etc.).); Erbringung
        ...
        <ul>
          ...
          <li>
            ...
            übernehmen; <strong>Rechtsgrundlagen:</strong>
            Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).
          </li>
          <li>
        ...
        <h2 className={`${style.all} ${style.headline}`} id="m182">
        ...
        <h2 className={`${style.all} ${style.headline}`} id="m328">
          Plugins und eingebettete Funktionen sowie Inhalte
        </h2>
        <p>
          ...
          als &quot; Drittanbieter &quot;) bezogen werden. Dabei kann es sich
        ...
        <h2 className={`${style.all} ${style.headline}`} id="m15">
          Änderung und Aktualisierung der Datenschutzerklärung
        </h2>
        <p>
        ...
        <h2 className={`${style.all} ${style.headline}`} id="m10">
        ...
        <h2 className={`${style.all} ${style.headline}`} id="m42">
