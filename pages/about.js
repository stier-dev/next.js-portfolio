      ...
      <div className={style.mainContainer}>
        <div className={style.textContainer}>
          ...
          <p className={style.paragraph}>
            ...
            Erfahrung im Screendesign und in Gestaltung im Allgemeinen habe.
            Somit fällt es mir leicht Entwürfe ästhetisch umzusetzen. Mit mir
            habt ihr einen Programmierer UND einen Designer.
          </p>
          ...
          <p className={style.paragraph}>
            In Kommunikationsworkshops und aus Büchern über die Modelle von
            Schulz Von Thun, Vera F. Birkenbihl oder Marshall B. Rosenberg habe
            ich viel über Kommunikation gelernt. Zu dem hatte ich in über 5
            Jahren Selbstständigkeit ständig Kundenkontakt. Da ich in der
            Ukraine aufgewachsen bin, in Deutschland lebe und im Süden Urlaub
            mache kenne ich unterschiedliche Kulturen und fühle mich in ihnen
          ...
          <p className={style.paragraph}>
            „Kinder wollen nicht wie Fässer gefüllt, sondern wie Fackeln
            entzündet werden.“ Francois Rabelais <br />
            <br />
            Spielerisch vermittele ich / wir den Kids, dass Geräte wie
            Smartphones und Drohnen oder Software und Webseiten kein Hexenwerk
            sind. Ziel ist, dass die Kids das Gefühl bekommen ihr Umfeld
            gestalten und neue Technologien entwickeln zu können. Wichtig ist,
            dass sie Spaß an der Sache haben und sich gegenseitig helfen und
            motivieren.
          </p>
          <h2 className={style.subHeadline}>Web Development für die Großen</h2>
          <p className={style.paragraph}>
            Ihr seid auf der Suche nach einem leidenschaftlichen Lehrer für
            euere Hochschule, Privatschule, Boot Camp oder ähnliches? Dann seit
            Ihr bei mir an der richtigen Adresse. Ich finde es gibt nichts
            schöneres, als sich gegenseitig etwas bei zu bringen und voneinander
            zu lernen. Nach jedem Workshop / Unterricht fühle ich mich
            lebendiger und lebensfroher als vorher. Als Jr. Entwickler weiß ich
            noch genau wie es ist die ersten Funktionen zu schreiben, kenne die
            Herausforderungen und Unklarheiten, die am Anfang des Lehrweges
            auftauchen. Dadurch kann ich mich gut in meine Schüler einfühlen und
            geduldig ihre Fragen beantworten.
          </p>
